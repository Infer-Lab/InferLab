mod measurement_data_asset;
mod wire;

use schemars::generate::SchemaSettings;

pub use measurement_data_asset::{
    EvalPreparedSourceBinding, MeasurementDataAssetAcquiredSource,
    MeasurementDataAssetCacheOutcome, MeasurementDataAssetCacheStore,
    MeasurementDataAssetContentEntry, MeasurementDataAssetEffectiveSelection,
    MeasurementDataAssetPreparationNextPhase, MeasurementDataAssetPreparationPhase,
    ...
    MeasurementDataAssetSourceBytesOutcome, MeasurementDataAssetSourceInput,
    MeasurementDataAssetVerification, MeasurementDataFiles,
};
pub use wire::{
    ...
    BenchAgenticSourceInput, BenchAgenticSourceVerification, BenchCacheStartInput, BenchCaseInput,
    BenchClientRequest, BenchClientResult, BenchDatasetCacheState, BenchDatasetCatalogInput,
    BenchDatasetFilterInput, BenchDefinitionInput, BenchInclusiveUniformInput, BenchLoadInput,
    BenchNativeInvocation, BenchPopulationInput, BenchPopulationPreparationRequest,
    BenchPopulationPreparationResult, BenchPrefixConditioningInput, BenchPrefixGeometrySummary,
    BenchPrefixSharingInput, BenchPromptCacheObservation, BenchPromptInput, BenchPromptRouteInput,
...
pub const MEASUREMENT_WIRE_SOURCE: &str =
    "crates/inferlab-protocol/src/wire.rs and measurement_data_asset.rs";

#[must_use]
pub fn protocol_schema() -> schemars::Schema {
    schema_for::<AdapterProtocol>(PROTOCOL_SCHEMA_ID, PROTOCOL_WIRE_SOURCE)
}

#[must_use]
pub fn measurement_schema() -> schemars::Schema {
    schema_for::<MeasurementProtocol>(MEASUREMENT_SCHEMA_ID, MEASUREMENT_WIRE_SOURCE)
}

fn schema_for<T: schemars::JsonSchema>(id: &str, wire_source: &str) -> schemars::Schema {
    ...
    schema.ensure_object().insert(
        "$comment".to_owned(),
        format!("Generated from {wire_source}; do not edit.").into(),
    );
    schema
}
